...
| Baseline formatting gate and artifact hygiene                                                                                                                                                                                                                                                                                                    | `still blocking trusted release`       | local `pnpm lint` failed on `2026-04-04`; Prettier still cannot parse committed pseudo-JSON artifacts such as `artifacts/nightly/pack-smoke/verify-pack.json` and `artifacts/nightly/pack-smoke/verify-exports.json`, and the worktree still contains formatting drift in tracked files                                                     | The required `lint-and-format` gate is not green, and some committed evidence artifacts are still not clean machine-parseable JSON.                                                                                                                              |
